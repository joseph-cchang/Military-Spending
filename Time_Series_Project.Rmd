---
title: "History of Military Spending"
author: "Joseph Chang"
...
This will be model diagnostics for model 1: SARIMA (1,1,0),(1,0,0), period at 9. I found mean then variance of the residuals of model 1. Since the training data has 51 observations, the box.test will have sqrt of 65 or around 7.
...
This will be model diagnostics for model 2: SARIMA (1,1,0),(1,0,1), period at 9. I found mean then variance of the residuals of model 2. Since the training data has 51 observations, the box.test will have sqrt of 65 or around 7.
...
# Testing independence of residuals
Box.test(res2, lag = 7, type = c("Box-Pierce"), fitdf = 3)
Box.test(res2, lag = 7, type = c("Ljung-Box"), fitdf = 3)
Box.test(res2^2, lag = 7, type = c("Ljung-Box"), fitdf = 0)
