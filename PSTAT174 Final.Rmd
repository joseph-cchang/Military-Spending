...
# Based from the ACF, PACF graphs, one candidate for this model is ARMA(9,9). Since ACF and PACF both show lag 9 outside the confidence interval, one could assume this to be ARMA(9,9). 

# maybe not...Another candidate could be SARIMA(0,2,0)(1,0,1)_9. Since I found difference to be 2, d=2, P = Q = 1, and seasonality at 9. 
```
...
## AICC comparison
```{r}
fit_ma9 <- arima(spent, order=c(0,0,9), method= "ML")
fit_ar9 <- arima(spent, order=c(9,0,0), method= "ML")
fit_arma99 <- arima(spent, order=c(9,0,9), method = "ML")
