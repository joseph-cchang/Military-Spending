...
First, I read in the data and plotted a time series model for the Defense Budget each of the years. Additionally, I created a histogram to visualize the Defense Budget.
...
hist(training, col = "light blue", main = "histogram of the original data - training")
...
spent = (1/lambda)*(training^lambda-1)
```
...
op=par(mfrow=c(2,2))
plot.ts(training, main = "Original trained Time Series")
...
# Final model 2
fit2 <- arima(training, order = c(9,2,1), method = "ML")
fit2
AICc(fit2)
# stationary because less than abs 1, and all AR are invertible
